...
public:
    std::vector<std::pair<std::string, std::wstring>> process_barcodes(
        ...
        auto temp_array = tree::TreeNode::sort_nodes(nodes, edges, _cos_angle, _max_distance_h, _max_distance_v, _w, _h);
